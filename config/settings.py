...
CORS_ALLOWED_ORIGINS = [
    'http://read-and-write.example.com',  # Замените на адрес вашего frontend сервера
]

CSRF_TRUSTED_ORIGINS = [
    "https://read-and-write.example.com",  # Замените на адрес вашего frontend сервера
    'http://127.0.0.1:8000/',  # Адрес backend сервера
]
